...
# Dan FootNotes for installing on Home Cluster


## Metal Lb Config Setup
```
kubectl apply -f https://raw.githubusercontent.com/metallb/metallb/v0.13.4/config/manifests/metallb-native.yaml

kubectl apply -f metalConfig_pool.yaml
kubectl apply -f metal_l2.yaml
```

## Tiller Bullshit


### Install Tiller (Only Needed for fresh installs)
```
...
```
helm install --namespace pihole --values ./charts/pihole/values.yaml mojo2600/pihole
```